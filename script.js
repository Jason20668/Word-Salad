...
const GnoNum = prompt ('Give me a Number Below 10');
...
const PosVer = prompt ('Give me a Positive Past Tense Verb');
...
All the gnomes ${PosVer} as they could now make their ${BakedG} and gave James a ${Reward} as a reward. They told James he was welcome any time in ${Town} and
